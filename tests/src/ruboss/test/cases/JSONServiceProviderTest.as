package ruboss.test.cases {
  ...
  public class JSONServiceProviderTest extends TestCase {
    ...
    public function testObjectUnmarshallingWithRelationships():void {
      ...
      var users:ModelsArray = Ruboss.services.getServiceProvider(JSONServiceProvider.ID).unmarshall(marshalledUsers) as ModelsArray;
      ...
      var addresses:ModelsArray = Ruboss.services.getServiceProvider(JSONServiceProvider.ID).unmarshall(marshalledAddresses) as ModelsArray;
