...
For details on how to get started with the RestfulX framework refer to:
    ...
    [RestfulX](http://restfulx.org)
    
== Getting Involved

Report bugs or track framework development progress:

    [RestfulX @ Lighthouse](http://restfulx.lighthouseapp.com/dashboard)
  
Get involved with the community:
      
    [RestfulX Google Group](http://groups.google.com/group/restfulx-framework)
